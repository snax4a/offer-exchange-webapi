...
namespace Migrators.PostgreSQL.Migrations.Application
{
    ...
    [Migration("20220806173950_MakeAccountNullableInStripeEntity")]
    partial class MakeAccountNullableInStripeEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Billing.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<short>("MonthlyNumberOfInquiriesSent")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Billing.StripeEvent", b =>
                {
                    ...
                    b.ToTable("StripeEvents", "Billing");
                });

            modelBuilder.Entity("FSH.WebApi.Domain.Billing.StripePrice", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
                    ...
                    b.Property<long?>("TrialPeriodDays")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("StripePrices", "Billing");
                });

            modelBuilder.Entity("FSH.WebApi.Domain.Billing.StripeProduct", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
                    ...
                    b.ToTable("StripeProducts", "Billing");
                });

            modelBuilder.Entity("FSH.WebApi.Domain.Billing.StripeSubscription", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
                    ...
                    b.ToTable("StripeSubscriptions", "Billing");
                });
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Exchange.Offer", b =>
                {
                    ...
                    b.HasIndex("ShippingAddressId", "TenantId")
                        .HasDatabaseName("IX_Offers_ShippingAddressId");
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Billing.Customer", b =>
                {
                    b.HasOne("FSH.WebApi.Domain.Billing.StripeSubscription", "CurrentSubscription")
                        .WithMany()
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Billing.StripePrice", b =>
                {
                    b.HasOne("FSH.WebApi.Domain.Billing.StripeProduct", "Product")
                        .WithMany("Prices")
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Billing.StripeSubscription", b =>
                {
                    b.HasOne("FSH.WebApi.Domain.Billing.Customer", "Customer")
                        .WithMany("Subscriptions")
                        .HasForeignKey("CustomerId")
                        .HasPrincipalKey("StripeCustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FSH.WebApi.Domain.Billing.StripePrice", "Price")
                        .WithMany()
