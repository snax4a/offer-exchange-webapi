...
public class RolesController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(ResourceAction.View, Resource.Roles)]
    ...
    [MustHavePermission(ResourceAction.View, Resource.RoleClaims)]
    ...
    [MustHavePermission(ResourceAction.Update, Resource.RoleClaims)]
    ...
    [HttpPost]
    [MustHavePermission(ResourceAction.Create, Resource.Roles)]
    ...
    [HttpDelete("{id}")]
    [MustHavePermission(ResourceAction.Delete, Resource.Roles)]
